...
environments {
    ...
    prod {
        ...
        url = 'groovier.github.io' // site URL, for example http://www.example.com
...
gh_pages_url = 'git@github.com:Groovier/groovier.github.io.git' // path to GitHub repository in format git@github.com:{username}/{repo}.git
