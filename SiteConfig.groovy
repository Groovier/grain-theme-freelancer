...
environments {
    ...
    prod {
        ...
        url = 'groovier.github.com' // site URL, for example http://www.example.com
...
gh_pages_url = 'git@github.com:Groovier/groovier.github.com.git' // path to GitHub repository in format git@github.com:{username}/{repo}.git
